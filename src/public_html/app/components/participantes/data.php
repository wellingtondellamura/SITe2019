...
function getOficinaFromParticipanteId($id){
  if (!isset($id))
    return null;
  $sql = "select o.titulo, o.id, o.descricao, o.foto, o.vagas, o.prerequisitos, o.carga_horaria, t.descricao as tipo_oficina from oficina o ".
        "left join tipo_oficina t on t.id = o.tipo_oficina_id". 
        " where o.participante_id = $id";
