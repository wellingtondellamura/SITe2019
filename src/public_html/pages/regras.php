<section>
  <header>
    <h1>Termos para participação no <?=$data['name']?></h1>
  </header>
  <main>
    ...
    <p class="text-muted h5 text-center">Sugerimos consultar na página de 'Minicursos' as exigências mínimas e a disponibilidade de vagas,
       bem como os horários de realização dos mesmos. <span class="badge badge-danger text-center">IMPORTANTE: Os valores pagos não poderão ser reembolsados.</span></p>
  </main>
</section>
